...
public class ChooseProspectingCustomer extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosecustomerprospecting, container, false);
        getActivity().setTitle("Choose Prospecting Customer");

        //-----START DECLARE---------------------------------------------------------------------------------------
        btn_add = (FloatingActionButton) v.findViewById(R.id.btn_addProspectingCustomer);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Customer/getDataProspekCustomer/";
    ...
    public void onClick(View v) {
        ...
        else if(v.getId() == R.id.btn_addProspectingCustomer){
    ...
    private class searchCustomer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                ...
                Index.jsonObject.put("customer_tipe", "1");
        ...
        protected void onPostExecute(String result) {
                ...
                if(jsonarray.length() > 0){
                    for (int i = jsonarray.length() - 1; i >= 0; i--) {
                        ...
                        if(!obj.has("query")){
                            ...
                            String hp = (obj.getString("customer_telepon"));
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Prospecting Customer Load Failed", Toast.LENGTH_LONG).show();
            }
        }
