...
public class ChooseGudang extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_choosegudang;
    private ImageButton ib_search;
    private ListView lv_gudang;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosegudang, container, false);
        getActivity().setTitle("Choose Warehouse");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_choosegudang = (EditText) v.findViewById(R.id.et_choosegudang);
        itemadapter = new ItemListAdapter(getActivity(), R.layout.list_item, new ArrayList<ItemAdapter>());
        lv_gudang = (ListView) v.findViewById(R.id.lv_gudang);
        lv_gudang.setAdapter(itemadapter);
        ib_search = (ImageButton) v.findViewById(R.id.ib_search);
        ib_search.setOnClickListener(this);
        lv_gudang.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("Stock Report")){
                    ...
                    editor.putString( "nomorgudang", tv_nomor.getText().toString());
                    editor.putString( "namagudang", tv_nama.getText().toString());
                    editor.commit();
        ...
        lv_gudang.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldatagudang/";
                        new searchGudang().execute( actionUrl );
                    }
                }
            }
    ...
    private class searchGudang extends AsyncTask<String, Void, String> {
        String search = et_choosegudang.getText().toString();
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Warehouse Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
