...
public class ChooseKategori extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_choosekategori;
    private ImageButton ib_search;
    private ListView lv_kategori;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosekategori, container, false);
        getActivity().setTitle("Choose Category");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_choosekategori = (EditText) v.findViewById(R.id.et_choosekategori);
        ...
        lv_kategori.setAdapter(itemadapter);
        ib_search = (ImageButton) v.findViewById(R.id.ib_search);
        ib_search.setOnClickListener(this);
        lv_kategori.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("Stock Report")){
                    ...
                    editor.putString( "nomorkategori", tv_nomor.getText().toString());
                    editor.putString( "namakategori", tv_nama.getText().toString());
                    editor.commit();
        ...
        lv_kategori.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldatakategori/";
                        new searchKategori().execute( actionUrl );
                    }
                }
            }
    ...
    private class searchKategori extends AsyncTask<String, Void, String> {
        String search = et_choosekategori.getText().toString();
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Category Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
