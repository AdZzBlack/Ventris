...
public class ChooseProject extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_chooseproject;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.chooseproject, container, false);
        getActivity().setTitle("Choose Project");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_chooseproject = (EditText) v.findViewById(R.id.et_chooseproject);
        itemadapter = new ItemListAdapter(getActivity(), R.layout.list_item, new ArrayList<ItemAdapter>());
        lv_project = (ListView) v.findViewById(R.id.lv_project);
        lv_project.setAdapter(itemadapter);
        ...
        lv_project.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("Schedule Task")){
                    ...
                    editor.putString( "nomorproject", tv_nomor.getText().toString());
                    editor.putString( "namaproject", tv_nama.getText().toString());
                    editor.commit();
        ...
        lv_project.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldataproyek/";
                        new searchProject().execute( actionUrl );
                    }
                }
            }
    ...
    private class searchProject extends AsyncTask<String, Void, String> {
        String search = et_chooseproject.getText().toString();
...
//                Index.jsonObject.put("limit", counter);
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Project Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
