...
public class ScheduleTaskReview extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.scheduletask_review, container, false);
...
//                        transaction.addToBackStack(null);
                        ...
                        Toast.makeText(getContext(), "Schedule Task failed", Toast.LENGTH_LONG).show();
                    }
                }
                Index.pDialog.dismiss();
            }catch(Exception e)
