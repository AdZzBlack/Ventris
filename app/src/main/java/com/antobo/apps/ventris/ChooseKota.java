...
public class ChooseKota extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_choosekota;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosekota, container, false);
        getActivity().setTitle("Choose City");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_choosekota = (EditText) v.findViewById(R.id.et_choosekota);
        ...
        lv_area.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("customer")){
                    ...
                    editor.putString( "nomorkota", tv_nomor.getText().toString());
                    editor.putString( "namakota", tv_nama.getText().toString());
                    editor.commit();
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldatakota/";
    ...
    private class searchArea extends AsyncTask<String, Void, String> {
        String search = et_choosekota.getText().toString();
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "City Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
