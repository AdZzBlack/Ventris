...
public class ChooseTipe extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_choosetipe;
    private ImageButton ib_search;
    private ListView lv_tipe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosetipe, container, false);
        getActivity().setTitle("Choose Type");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_choosetipe = (EditText) v.findViewById(R.id.et_choosetipe);
        itemadapter = new ItemListAdapter(getActivity(), R.layout.list_item, new ArrayList<ItemAdapter>());
        lv_tipe = (ListView) v.findViewById(R.id.lv_tipe);
        lv_tipe.setAdapter(itemadapter);
        ib_search = (ImageButton) v.findViewById(R.id.ib_search);
        ib_search.setOnClickListener(this);
        lv_tipe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("Stock Report")){
                    ...
                    editor.putString( "nomortipe", tv_nomor.getText().toString());
                    editor.putString( "namatipe", tv_nama.getText().toString());
                    editor.commit();
        ...
        lv_tipe.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldatatipe/";
                        new searchTipe().execute( actionUrl );
                    }
                }
            }
    ...
    private class searchTipe extends AsyncTask<String, Void, String> {
        String search = et_choosetipe.getText().toString();
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Type Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
