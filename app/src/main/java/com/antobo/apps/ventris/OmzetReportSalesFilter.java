...
public class OmzetReportSalesFilter extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.omzetreport_sales_filter, container, false);
    ...
    public void onClick(View v) {
        ...
        poseditor.putString( "position", "Omzet Report Sales");
        poseditor.commit();

        v.startAnimation(Index.buttoneffect);
        if(v.getId() == R.id.btn_check){
            if(Index.omzetsharedpreferences.getString("startdate", "").equals("") && Index.omzetsharedpreferences.getString("enddate", "").equals(""))
            {
                Toast.makeText(getContext(), "End date and start date required", Toast.LENGTH_LONG).show();
            }
