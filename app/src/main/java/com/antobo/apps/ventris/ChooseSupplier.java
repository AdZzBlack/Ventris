...
public class ChooseSupplier extends Fragment implements View.OnClickListener {

    private ItemListAdapter itemadapter;

    private EditText et_choosesupplier;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.choosesupplier, container, false);
        getActivity().setTitle("Choose Supplier");

        //-----START DECLARE---------------------------------------------------------------------------------------
        et_choosesupplier = (EditText) v.findViewById(R.id.et_choosesupplier);
        itemadapter = new ItemListAdapter(getActivity(), R.layout.list_item, new ArrayList<ItemAdapter>());
        lv_supplier = (ListView) v.findViewById(R.id.lv_supplier);
        lv_supplier.setAdapter(itemadapter);
        ...
        lv_supplier.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if(Index.positionsharedpreferences.getString("position", "").equals("Sales Order")){
                    ...
                    editor.putString( "nomorsupplier", tv_nomor.getText().toString());
                    editor.putString( "namasupplier", tv_nama.getText().toString());
                    editor.commit();
        ...
        lv_supplier.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if((lastInScreen == totalItemCount) && totalItemCount != 0){
                    if(scroll == true)
                    {
                        ...
                        String actionUrl = "Master/alldatasupplier/";
                        new searchSupplier().execute( actionUrl );
                    }
                }
            }
    ...
    private class searchSupplier extends AsyncTask<String, Void, String> {
        String search = et_choosesupplier.getText().toString();
        ...
        protected void onPostExecute(String result) {
            ...
            {
                e.printStackTrace();
                Toast.makeText(getContext(), "Supplier Load Failed", Toast.LENGTH_LONG).show();
                Index.pDialog.dismiss();
            }
        }
