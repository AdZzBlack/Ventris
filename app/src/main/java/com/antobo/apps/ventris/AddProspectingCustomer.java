...
public class AddProspectingCustomer extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.prospectingcustomer_add, container, false);
        getActivity().setTitle("Add Prospecting Customer");
    ...
    public void onClick(View v) {
        if(!Index.positionsharedpreferences.getString("position", "").equals("Schedule Task")){
            ...
            poseditor.putString( "position", "prospeccustomer");
            poseditor.commit();
        }
    ...
    private class add extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                ...
                Index.jsonObject.put("isProspek", "1");
            ...
            try {
                ...
                for (int i = jsonarray.length() - 1; i >= 0; i--) {
                    ...
                    if(success.equals("true")){
                        Toast.makeText(getContext(), "Add Prospk Customer Completed", Toast.LENGTH_LONG).show();
                    ...
                    {
                        Toast.makeText(getContext(), "Add Prospek Customer Failed", Toast.LENGTH_LONG).show();
                    }
                }
