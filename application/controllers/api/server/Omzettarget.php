...
class Omzettarget extends REST_Controller { 
    ...
    function __construct()
    {
        ...
        $this->methods['event_post']['limit'] = 1000000; // 500 requests per hour per event/key
        // $this->methods['event_delete']['limit'] = 50; // 50 requests per hour per event/key
        $this->methods['event_get']['limit'] = 1000000; // 500 requests per hour per event/key
    ...
    function getOmzetSales_post(){     
        ...
        $bex_nomor   = (isset($jsonObject["bex_nomor"])   ? $this->clean($jsonObject["bex_nomor"])   : "17");
    ...
    function getOmzetSalesTotal_post(){     
        ...
        if($reminder == "true"){
            if( $vcGCMId != "null" ){      
                $this->send_gcm($vcGCMId, $this->ellipsis("Reminder Omset"),'Omset : Rp.' . number_format($total_omzet,2),'Dashboard',$bex_nomor,"tes");   
            }
        }
